...
<body>
	...
	<button id="clearall" class="button" onclick="document.location.href='clear.php';">Clear All Data</button>
	<form name="postlog" method="post" action="review2.php">
	<!-- Hidden Data -->
	<div class="hidden">
		Participant ID json:<a href="#" onclick="$('#ParticipantID-json').slideToggle(500);">[Toggle]</a><br>
		<textarea id="ParticipantID-json" name="ParticipantID-json" class="box" readonly="true"></textarea>
		queries-json:<a href="#" onclick="$('#queries-json').slideToggle(500);">[Toggle]</a><br>
